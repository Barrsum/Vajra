...
| Stylized sky shader with clouds | Sky: procedural sun, moon phases, 3-layer clouds, stars. Ported to compile in 4.7 and rewired to per-world data | [godotshaders.com](https://godotshaders.com/shader/stylized-sky-shader-with-clouds/) | CC0 (godotshaders default) | 2026-08-15 |
| FastNoiseLite fractal ping-pong | The cloud noise inside that shader, ported to GLSL | [Auburn/FastNoiseLite](https://github.com/Auburn/FastNoiseLite) | MIT | 2026-08-15 |
| Moon phase sphere intersect | The moon terminator maths in the same shader | [Kelvin van Hoorn](https://kelvinvanhoorn.com/2022/03/17/skybox-tutorial-part-1/) | Tutorial, credited | 2026-08-15 |
| Synty Core Drop-in "Foliage" shader | Trees in all four levels: leaf/trunk split by vertex colour, wind, and the emissive canopies in the garden. Meshes are generated in `scripts/foliage.gd` to carry the vertex colours it needs | [godotshaders.com](https://godotshaders.com/shader/synty-core-drop-in-foliage-shader/), Giancarlo Niccolai | MIT | 2026-08-15 |
| Spatial Fire Raymarched v2.0 | The large campfires in level 4. Volumetric, raymarched; 3D noise generated in `scripts/fx_textures.gd` | [godotshaders.com](https://godotshaders.com/shader/spatial-fire-raymarched-v2-0/), Dari0us | CC0 | 2026-08-15 |
| Stylized BOTW Fire | The small braziers. Cheap scrolling-noise flame; all six textures generated | [godotshaders.com](https://godotshaders.com/shader/stylized-botw-fire/), Loop_Box | CC0 | 2026-08-15 |
| 3D Lightning shader | The storm in level 4. A 3D take on FencerDevLog's lightning | [godotshaders.com](https://godotshaders.com/shader/3d-lightning-shader/), Loop_Box | CC0 | 2026-08-15 |
